...
def main():
    ...
    while os.path.exists(path % number_of_files):
        ...
        name_of_file_1 = 'dyn_position_plot%s.svg'
        name_of_file_2 = 'dyn_position_delta%s.svg'
        name_of_file_3 = 'dyn_position_in_the_same_plot%s.svg'
        name_of_file_4 = 'dyn_lidar%s.gif'
        name_of_file_5 = 'dyn_delta_coordinate_w_respect_to_with_lidar%s.svg'
        name_of_file_6 = 'dyn_vel_over%s.svg'
