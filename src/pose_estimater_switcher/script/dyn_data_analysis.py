...
path = str(Path.home().joinpath("test_data", "dynanic_log%s.csv"))
path_output = str(Path.home().joinpath("test_data", "dyn_output%s.csv"))
...
def main():
    ...
    number_of_files = 0
    output_file_name = 'dyn_outputdata.csv'
    ...
    while os.path.exists(path % number_of_files):
        ...
        name_of_file_1 = 'dyn_position_plot%s.png'
        name_of_file_2 = 'dyn_position_delta%s.png'
        name_of_file_3 = 'dyn_position_in_the_same_plot%s.png'
        name_of_file_4 = 'dyn_lidar%s.gif'
        name_of_file_5 = 'dyn_delta_coordinate_w_respect_to_with_lidar%s.png'
        name_of_file_6 = 'dyn_vel_over%s.png'
        name_of_file_7 = 'dyn_coordinate_over_time%s.png'
