...
if [ -f "$FILE1" ]; then
    ...
    #sudo add-apt-repository 'deb-src [arch=amd64] http://security.ubuntu.com/ubuntu focal-security main restricted'
...
cd Downloads/
curl -o arduino-1.8.15-linux64.tar.xz https://downloads.arduino.cc/arduino-1.8.15-linux64.tar.xz
tar -xf arduino-1.8.15-linux64.tar.xz-C /home/$USER/
cd
cd arduino-1.8.15
sudo ./install.sh
